                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <a href="{{ route('items.index') }}"
                       class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 
                              hover:bg-[#b5cadf] hover:text-gray-900 transition">
                        Items
                    </a>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent 
                                       ...
                                       hover:bg-[#b5cadf] hover:text-gray-900">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                        class="inline-flex items-center justify-center p-2 rounded-md
                               ...
                               hover:bg-[#b5cadf] hover:text-gray-900
                               focus:outline-none focus:bg-[#b5cadf] focus:text-gray-900">
